...
function CustomConnectionTab(props: { label: string }) {
  ...
  return (
    <form className={styles.tabContent} onSubmit={onSubmit}>
      <p style={{ marginTop: 0 }}>
        Connect Baddie.stream Live with a custom server using Baddie.stream cloud server.
      </p>
      <input
        id="serverUrl"
        name="serverUrl"
        type="url"
        placeholder="Baddie.stream Live Server URL: wss://*baddie.stream"
        required
      />
      <textarea
        id="token"
  ...
  return (
    <>
      ...
      <footer data-lk-theme="default">
         Powered by{' '}
        <a href="https://baddie.stream" rel="noopener" style={{color: '#00ff88'}}>
           😈 BADDIE.STREAM
        </a>
      </footer>
    </>
